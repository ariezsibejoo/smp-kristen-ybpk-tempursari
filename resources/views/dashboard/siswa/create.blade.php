...
<div class="col-lg-4">
    ...
    <form method="POST" action="/dashboard/siswa">
      ...
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="jenkel" id="jenkel1" value="Laki-laki" @if(old('jenkel')) checked @endif checked>
        <label class="form-check-label" for="jenkel1">Laki-laki</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="jenkel" id="jenkel2" value="Perempuan" @if(old('jenkel')) checked @endif>
      ...
      <div class="mb-3">
        ...
        <input type="date" class="form-control @error('tanggal_lahir') @enderror" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" required>
        @error('date')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
