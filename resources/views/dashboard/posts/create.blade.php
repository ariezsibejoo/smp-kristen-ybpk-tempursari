...
<div class="col-lg-8">
    ...
    {{-- enctype multipart buat upload file --}}
    <form method="POST" action="/dashboard/posts" class="mb-5" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" readonly required value="{{ old('title') }}">
        @error('slug')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
