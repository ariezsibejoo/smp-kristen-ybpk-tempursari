...
<div class="col-lg-8">
    {{-- method put otomatis mengarah ke method update di controller resource --}}
    <form method="POST" action="/dashboard/posts/{{ $post->slug }}" class="mb-5" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" readonly required value="{{ old('title', $post->slug) }}">
        @error('slug')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
...
<script>
    ...
    // title.addEventListener('change') kalau mau selesai dulu baru dislug
