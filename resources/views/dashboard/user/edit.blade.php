...
<div class="col-lg-4">
    ...
    <form method="POST" action="/dashboard/user/{{ $user->username }}" class="mb-5">
        @method('put')
        @csrf
      <div class="mb-3">
      ...
      <select class="form-select" name="is_admin">
        <option value="0" @if (old('is_admin', $user->is_admin) == "0") selected="selected" @endif>Pengguna</option>
        <option value="1" @if (old('is_admin', $user->is_admin) == "1") selected="selected" @endif>Administrator</option>
      </select>
